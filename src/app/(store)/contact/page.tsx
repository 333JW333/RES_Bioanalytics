...
export const metadata: Metadata = {
  ...
  description:
    "Questions about specifications, documentation, orders, bulk allocation, or the site — send the EcoPeps team an enquiry.",
};

export default function ContactPage() {
  return (
    <div className="relative min-h-[calc(100dvh-6.5rem)]">
      <SacredGeometryBackground />
      <div className="container-page relative max-w-2xl py-16">
