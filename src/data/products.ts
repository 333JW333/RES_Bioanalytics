...
export const products: Product[] = [
  ...
  },
  {
    ...
    coaPanel: {
      ...
      testedMassMg: 15.6,
      labeledMassMg: 15,
      massVariancePercent: 4,
      tests: [
        { label: "Identity", result: "Confirmed" },
        { label: "Heavy metals", result: "Pass" },
        { label: "Microbial (PCR)", result: "Pass" },
        { label: "Endotoxin", result: "Pass" },
        { label: "Fentanyl screen", result: "Not detected" },
        { label: "Appearance", result: "White lyophilized powder" },
      ],
      lot: "SAMPLE-RETA-0001",
      searchCode: "SAMPLE-CODE-0001",
      pdfUrl: "/coas/retatrutide-coa-sample.pdf",
