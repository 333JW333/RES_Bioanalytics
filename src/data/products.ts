...
export const products: Product[] = [
  ...
  },
  {
    ...
    coaPanel: {
      ...
      tests: [
        { label: "Identity", result: "Confirmed (Task #214265)" },
        { label: "Endotoxin", result: "1.564 EU/vial (Task #214266)" },
        { label: "Sterility — TAMC", result: "Pass (Task #214267)" },
        { label: "Sterility — TYMC", result: "Pass (Task #214267)" },
      ],
      lot: "PSRETA15-1",
